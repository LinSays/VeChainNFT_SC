	...
	OwnableUpgradeable
{
	...
	function availableTokenLength() external view returns (uint256) {
	...
	function safeMint(address to, uint256 tokenId) public onlyOwner {
		...
		_setTokenURI(tokenId, createFullUriTokenString(_baseUri, tokenId));
	}
